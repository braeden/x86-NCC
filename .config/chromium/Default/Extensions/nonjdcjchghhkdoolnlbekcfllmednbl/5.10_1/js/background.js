...
function enableFairshare() {
    if (window.fairshare_app != undefined) {
        if (options && options.enableStats && !window.fairshare_app.is_enabled()) {
            window.fairshare_app.enable();
        } else if ((!options || !options.enableStats) && window.fairshare_app.is_enabled()) {
            window.fairshare_app.disable();
        }
    }
}
